...
public class Value {
	...
	public static final String INFO_MESSAGE = 
		  "Trường: Đại Học Công Thương Khoa Công Nghệ Thông Tin\n"
		+ "Môn: Công Nghệ Java\n"
		...
		+ "MSSV: 2001216046\n"
		+ "Nội dung:\n"
		+ " Game cờ caro sử dụng thuật toán cắt tỉa alpha beta, bài tập nhóm môn Công Nghệ Java!";
	public static final String INTRODUCE_MESSAGE = 
		...
		+ " trên một bàn cờ vây (20x20). Quân đen đi trước và người chơi lần lượt"
		...
		+ "\r\n" 
		+ "Các luật cơ bản: Ván cờ được chơi trên bàn cờ 20 x 20 dòng kẻ."
