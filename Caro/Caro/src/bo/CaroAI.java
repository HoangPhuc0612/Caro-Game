...
public class CaroAI {
	...
	// Hàm này chọn nước đi tối ưu cho AI bằng cách sử dụng thuật toán Alpha-Beta Pruning
...
//    	root.printState();
    ...
    // Hàm này thực hiện thuật toán Alpha-Beta Pruning để tìm nước đi tối ưu cho AI.
    // Nó đánh giá mỗi ô trống trong bảng và chọn ra những ô có giá trị tối ưu nhất.
